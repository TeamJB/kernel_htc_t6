...
#include "msm_camera_i2c.h"
			...
			|| defined(CONFIG_MACH_T6_UL) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_T6_WL)\
			|| defined(CONFIG_MACH_T6_WHL) || defined(CONFIG_MACH_DUMMY) || defined(CONFIG_MACH_DUMMY)
